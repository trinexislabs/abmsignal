  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-[#a1a1aa] mt-0.5">Every playbook across all customers, with run status.</p>
      </div>
      ...
      <Card className="bg-[#141419] border-white/[0.06] overflow-hidden">
        <div className="hidden md:grid grid-cols-[1fr_180px_130px_130px] gap-4 px-5 py-3 border-b border-white/[0.06] text-[11px] font-medium text-[#a1a1aa] uppercase tracking-wider">
          <span>Playbook</span>
          <span>Owner</span>
          <span>Status</span>
        ...
        {result.rows.length === 0 ? (
          <p className="text-sm text-[#a1a1aa] px-5 py-12 text-center">No playbooks match your filters.</p>
        ) : (
            ...
            {result.rows.map((p) => (
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[11px] text-[#a1a1aa] truncate">{p.ownerEmail ?? 'no owner'}</p>
                </div>
