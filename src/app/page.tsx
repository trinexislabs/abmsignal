...
const agentStatuses = [
  { name: 'Orchestrator', status: 'routing tasks', color: '#10B981', active: true },
  { name: 'Researcher', status: 'scanning 47 sources', color: '#2563EB', active: true },
  { name: 'Writer', status: 'drafting sequences', color: '#F59E0B', active: true },
  { name: 'Reviewer', status: 'quality check pending', color: '#6B7280', active: false },
]
...
const GROUP_COLORS: Record<SectionGroup, { text: string; border: string; bg: string; dot: string }> = {
  Intelligence: { text: '#60A5FA', border: '#2563EB/30', bg: '#1E3A8A/15', dot: '#2563EB' },
  Positioning:  { text: '#A78BFA', border: '#8B5CF6/30', bg: '#2D1B69/20', dot: '#8B5CF6' },
  Outreach:     { text: '#34D399', border: '#10B981/30', bg: '#0B3D2E/30', dot: '#10B981' },
  Execution:    { text: '#FCD34D', border: '#F59E0B/30', bg: '#451A03/20', dot: '#F59E0B' },
}
  ...
  return (
    <div className="min-h-screen bg-[#0B0F13] text-white">
      ...
      <section
        ...
        style={{ background: 'linear-gradient(135deg, #0B0F13 0%, #0B3D2E 40%, #0B0F13 100%)' }}
      >
        {/* Depth glows on top of the gradient */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[500px] bg-[#10B981]/6 rounded-full blur-[140px] pointer-events-none" />
        <div className="absolute bottom-0 right-1/4 w-[300px] h-[300px] bg-[#0B3D2E]/30 rounded-full blur-[80px] pointer-events-none" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-2">
                <Badge className="bg-[#0B3D2E] text-[#10B981] border border-[#10B981]/30 px-3 py-1 text-xs font-medium rounded-full">
                  <LogoMark className="w-3.5 h-3.5 mr-1" />
              ...
              <p className="text-lg text-[#E5E7EB] leading-relaxed max-w-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Link href="/auth/signup">
                  <Button
                    size="lg"
                    className="bg-[#10B981] hover:bg-[#059669] text-white font-semibold px-6 h-12 text-base rounded-xl glow-blue-sm"
                  >
                    Get Started
                ...
                <a href="#features">
                  <Button
                    variant="ghost"
                    size="lg"
                    className="text-[#A7F3D0] hover:text-white border border-[#10B981] hover:bg-[#10B981]/10 h-12 text-base rounded-xl px-6"
                  >
              ...
              {/* Stats bar */}
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-4 border-t border-[#374151]">
                {[
                  ...
                  <div key={stat.label} className="text-center sm:text-left">
                    <div className="text-2xl font-heading font-bold text-[#10B981]">
                      {stat.value}
                    </div>
            ...
            <div className="relative">
              <div className="bg-[#111827] border border-[#374151] rounded-2xl overflow-hidden glow-blue">
                {/* Terminal header */}
                <div className="flex items-center gap-2 px-4 py-3 border-b border-[#374151] bg-[#0B0F13]">
                  <div className="flex gap-1.5">
                    <div className="w-3 h-3 rounded-full bg-red-500/60" />
                    <div className="w-3 h-3 rounded-full bg-yellow-500/60" />
                    <div className="w-3 h-3 rounded-full bg-green-500/60" />
                  </div>
                  <span className="text-xs text-[#9CA3AF] ml-2 font-mono">
                    abmsignal — agent-cluster
                  </span>
                </div>

                {/* Target account header */}
                <div className="px-4 pt-4 pb-3 border-b border-[#1F2937]">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-xs text-[#9CA3AF] mb-1">Target Account</div>
                ...
                <div className="p-4 space-y-3">
                  {agentStatuses.map((agent) => (
                    <div
                      key={agent.name}
                      className="flex items-center gap-3 p-3 rounded-xl bg-[#0B0F13] border border-[#1F2937]"
                    >
                      <div className="relative">
                        <div
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-[#9CA3AF] truncate font-mono">
                      ...
                      {agent.active ? (
                        ...
                        <div className="w-4 h-4 rounded-full border border-[#374151] flex items-center justify-center">
                ...
                <div className="px-4 pb-4">
                  <div className="flex items-center justify-between text-xs text-[#9CA3AF] mb-2">
                    ...
                    <span className="text-[#10B981] font-medium">68%</span>
                  </div>
                  <div className="h-1.5 bg-white/[0.06] rounded-full overflow-hidden">
                    <div
                      className="h-full rounded-full bg-gradient-to-r from-[#0B3D2E] to-[#10B981]"
                      style={{ width: '68%' }}
                    />
                  </div>
                  <div className="mt-3 p-2.5 rounded-lg bg-[#10B981]/5 border border-[#10B981]/10">
              ...
              {/* Floating badge */}
              <div className="absolute -top-3 -right-3 bg-[#0B3D2E] border border-[#10B981]/30 rounded-xl px-3 py-2 flex items-center gap-2">
      ...
      {/* Trust / Benefit Band */}
      <section className="border-y border-[#374151] bg-[#0B0F13] py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
            <p className="text-sm text-[#9CA3AF] font-medium shrink-0 md:max-w-[180px] leading-snug">
              Trusted by Go-To-Market Teams at Leading Companies
            </p>
            <div className="w-px h-8 bg-[#374151] shrink-0 hidden md:block" />
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 flex-1">
              {[
                { icon: ShieldCheck, title: 'Enterprise Grade Security', desc: 'SOC2 Type II & GDPR compliant' },
                { icon: Users,        title: 'Built for GTM Teams',       desc: 'Salesforce, HubSpot, Marketo ready' },
                { icon: TrendingUp,   title: 'Proven Impact',             desc: 'Increase win rates, accelerate pipeline' },
                { icon: RefreshCw,    title: 'Always Improving',          desc: 'Continuously learning from outcomes' },
              ].map(({ icon: Icon, title, desc }) => (
                <div key={title} className="flex items-start gap-2.5">
                  <div className="w-7 h-7 rounded-lg bg-[#0B3D2E] border border-[#10B981]/20 flex items-center justify-center shrink-0 mt-0.5">
                    <Icon className="w-3.5 h-3.5 text-[#10B981]" />
                  </div>
                  <div>
                    <p className="text-xs font-semibold text-white leading-snug">{title}</p>
                    <p className="text-[11px] text-[#9CA3AF] leading-snug mt-0.5">{desc}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section id="features" className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <Badge className="bg-[#0B3D2E] text-[#10B981] border border-[#10B981]/30 mb-4">
              Features
            </Badge>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((feature) => {
              ...
              return (
                <div
                  key={feature.title}
                  className="group p-6 rounded-2xl bg-[#111827] border border-[#1F2937] card-hover"
                >
                  <div className="w-10 h-10 rounded-xl bg-[#0B3D2E]/60 border border-[#10B981]/20 flex items-center justify-center mb-4 group-hover:border-[#10B981]/40 transition-colors">
                    <Icon className="w-5 h-5 text-[#10B981]" />
                  </div>
                  <h3 className="font-heading font-semibold text-white mb-2">{feature.title}</h3>
                  <p className="text-sm text-[#E5E7EB] leading-relaxed">{feature.description}</p>
                </div>
              )
            })}
          </div>
      ...
      {/* How it works */}
      <section id="how-it-works" className="py-24 px-4 sm:px-6 lg:px-8 bg-[#0B0F13]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <Badge className="bg-[#0B3D2E] text-[#10B981] border border-[#10B981]/30 mb-4">
              How It Works
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            {/* Connector line */}
            <div className="hidden md:block absolute top-10 left-[calc(16.67%+1.5rem)] right-[calc(16.67%+1.5rem)] h-px bg-gradient-to-r from-transparent via-[#10B981]/30 to-transparent" />
                ...
                <div key={step.number} className="relative text-center">
                  <div className="inline-flex flex-col items-center">
                    <div className="relative mb-6">
                      <div className="w-20 h-20 rounded-2xl bg-[#111827] border border-[#10B981]/20 flex items-center justify-center glow-blue-sm">
                        <Icon className="w-8 h-8 text-[#10B981]" />
                      </div>
                      <div className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-[#0B3D2E] border border-[#10B981]/40 flex items-center justify-center">
                        <span className="text-[10px] font-bold text-[#10B981]">{i + 1}</span>
                      </div>
                    </div>
                    <div className="text-xs font-mono text-[#10B981] mb-2">{step.number}</div>
          ...
          <div className="mt-16 rounded-2xl bg-[#111827] border border-[#10B981]/15 relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-[#0B3D2E]/10 to-transparent pointer-events-none" />

            {/* Example header row */}
            <div className="relative flex flex-col md:flex-row items-start md:items-center gap-4 p-6 border-b border-[#1F2937]">
              <div className="w-12 h-12 rounded-xl bg-[#0B3D2E] border border-[#10B981]/30 flex items-center justify-center shrink-0">
            ...
            <div className="relative p-6">
              <p className="text-xs font-medium text-[#9CA3AF] uppercase tracking-wider mb-4">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-3">
                {PLAYBOOK_SECTIONS.map(({ label, description, group }, i) => (
                  <div key={label} className="flex items-start gap-2.5">
                    <span className="text-[10px] font-mono text-[#10B981]/60 mt-0.5 w-5 shrink-0 tabular-nums">
                      {String(i + 1).padStart(2, '0')}
                    </span>
                    <div>
                      <p className="text-xs font-medium text-white leading-snug">{label}</p>
                      <p className="text-[11px] text-[#9CA3AF]/80 leading-snug">{description}</p>
                    </div>
                  </div>
                ))}
              </div>
              <div className="flex flex-wrap gap-2 mt-5 pt-4 border-t border-[#1F2937]">
                ...
                <span className="text-[10px] text-[#9CA3AF]/60 self-center ml-1">
            ...
            {pricingPlans.map((plan) => (
              <div
                ...
                className={`relative p-6 rounded-2xl border flex flex-col ${'comingSoon' in plan && plan.comingSoon
                  ? 'bg-[#0B0F13] border-[#1F2937] opacity-60'
                  : plan.highlight
                    ? 'bg-[#0B3D2E]/20 border-[#10B981]/40 glow-blue'
                    : plan.oneTime
              ...
              >
                {'comingSoon' in plan && plan.comingSoon ? (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                    <Badge className="bg-white/10 text-[#9CA3AF] border border-[#374151] px-3 text-xs font-semibold whitespace-nowrap">
                      Coming Soon
                    </Badge>
                  </div>
                ) : plan.badge ? (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                    <Badge className="bg-[#10B981] text-white border-0 px-3 text-xs font-semibold whitespace-nowrap">
                      {plan.badge}
                    </Badge>
                  </div>
                ) : null}
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    {plan.oneTime && (
                      <span className="text-[10px] font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded bg-[#10B981]/10 text-[#10B981] border border-[#10B981]/20">
                        No subscription
                      </span>
                    )}
                  </div>
                  ...
                  <div className="flex items-end gap-1 mb-2">
                    ...
                    <span className="text-sm mb-1 text-[#9CA3AF]">{plan.period}</span>
                  </div>

                  <div className="text-xs font-medium px-2 py-1 rounded-md inline-block bg-white/5 text-[#9CA3AF]/60">
                    {plan.playbooks}
                  </div>
                </div>
                ...
                <ul className="space-y-2.5 mb-8 flex-1">
                  {plan.features.map((feature) => (
                    <li key={feature} className="flex items-start gap-2.5 text-sm">
                      ...
                      <span className="text-[#9CA3AF]/50">{feature}</span>
                    </li>
                  ))}
                </ul>
                    ...
                    <Button
                      className={`w-full ${
                        plan.highlight
                          ...
                          : plan.oneTime
                            ? 'bg-transparent text-[#A7F3D0] border border-[#10B981] hover:bg-[#10B981]/10'
                            : 'bg-white/5 hover:bg-white/10 text-white border border-[#374151]'
                      }`}
                    >
                      {plan.cta}
      ...
      {/* CTA Section */}
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[#0B0F13]">
        <div className="max-w-4xl mx-auto text-center">
          <div className="p-12 rounded-3xl bg-gradient-to-br from-[#0B3D2E]/40 to-[#0B0F13] border border-[#10B981]/20 relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-t from-[#10B981]/5 to-transparent pointer-events-none" />
            <div className="relative">
              <Badge className="bg-[#10B981]/10 text-[#10B981] border border-[#10B981]/20 mb-6">
                Ready to launch?
              </Badge>
              <h2 className="font-heading text-4xl sm:text-5xl font-bold text-white mb-4">
                Your next ABM campaign starts here
              </h2>
              <p className="text-[#E5E7EB] text-lg mb-8 max-w-xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Link href="/auth/signup">
                  <Button
                    size="lg"
                    className="bg-[#10B981] hover:bg-[#059669] text-white font-semibold px-8 h-12 text-base rounded-xl"
                  >
                    Get Started
                    <ArrowRight className="w-4 h-4 ml-1" />
                  </Button>
                ...
                <a href="#pricing">
                  <Button
                    variant="ghost"
                    size="lg"
                    className="text-[#A7F3D0] hover:text-white border border-[#10B981] hover:bg-[#10B981]/10 h-12 text-base rounded-xl px-8"
                  >
                    View pricing
                  </Button>
                </a>
      ...
      {/* Footer */}
      <footer className="border-t border-[#374151] py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex items-center gap-2.5">
              ...
              <Badge
                variant="secondary"
                className="text-[10px] px-1.5 py-0 bg-[#0B3D2E] text-[#10B981] border border-[#10B981]/30"
              >
                BETA
              </Badge>
            </div>

            <nav className="flex flex-wrap items-center justify-center gap-6 text-sm text-[#D1D5DB]">
