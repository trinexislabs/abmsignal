  ...
  return (
    <div className="min-h-screen bg-[#0B0F13] flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-md text-center">
        ...
        <div className="bg-[#111827] border border-red-500/20 rounded-2xl p-10 space-y-5">
          ...
          <div className="flex flex-col gap-2">
            <Link href="/auth/signin">
              <Button className="w-full bg-[#10B981] hover:bg-[#10B981]/90 text-white font-semibold rounded-xl">
                Try again
              </Button>
            </Link>
          </div>
