  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-md text-center">
        ...
        <div className="bg-[#141419] border border-white/[0.08] rounded-2xl p-10 space-y-5">
          <div className="w-16 h-16 rounded-2xl bg-[#1e3a5f]/60 border border-[#339af0]/20 flex items-center justify-center mx-auto">
            <Mail className="w-8 h-8 text-[#339af0]" />
          </div>
          ...
          <div className="bg-[#0d0d15] border border-white/[0.06] rounded-xl p-4 text-sm text-[#a1a1aa] text-left space-y-1.5">
