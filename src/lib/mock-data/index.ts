...
export const MOCK_PLAYBOOKS: Playbook[] = [
  {
    ...
    geography: 'Belgium (Western Europe)',
    priority_tier: 'tier1',
    status: 'complete',
    progress_pct: 100,
    agent_status: [
...
export const MOCK_CONTACTS: Contact[] = [
  {
    ...
    confidence: 'high',
    source: 'LinkedIn + Belfius IR page',
  ...
  },
  {
    ...
    confidence: 'medium',
    source: 'LinkedIn + Belfius press releases',
    verification_status: 'confirmed',
    created_at: '2026-05-12T10:00:00Z',
  },
  // KBC contacts for pb-003 (contact review)
  {
    id: 'c-007',
    playbook_id: 'pb-003',
    name: 'Johan Thijs',
    ...
    confidence: 'high',
    source: 'LinkedIn + KBC annual report',
  ...
  },
  {
    ...
    confidence: 'high',
    source: 'LinkedIn + KBC investor page',
    verification_status: 'pending',
    created_at: '2026-05-13T15:00:00Z',
  },
  {
...
export const MOCK_QUALITY_CHECKS: QualityCheck[] = [
  ...
  { id: 'qc-002', playbook_id: 'pb-001', check_number: 2, check_name: 'No generic outreach — every sequence references specific account signals', category: 'Personalization', status: 'pass', details: 'All 8 email sequences reference Belfius-specific signals: NBB Digital Finance Strategy 2024, Belfius Digital relaunch, March 2026 leadership announcement.', created_at: '2026-05-12T14:20:00Z' },
  { id: 'qc-003', playbook_id: 'pb-001', check_number: 3, check_name: '"Why Now" signals are recent (within 90 days) and specific', category: 'Relevance', status: 'pass', details: '4 signals found, all within 60 days: NBB AI governance framework (Feb 2026), Belfius Q4 2025 results with compliance cost mention, ECB DORA enforcement date (Jan 2026), new CTO appointment (March 2026).', created_at: '2026-05-12T14:20:00Z' },
  { id: 'qc-004', playbook_id: 'pb-001', check_number: 4, check_name: 'Cultural adaptation matches target geography + industry', category: 'Cultural Fit', status: 'pass', details: 'Belgian banking cultural rules applied: formal Dutch/French address, GDPR-first messaging, NBB/ECB regulatory framing, in-person meeting preference noted.', created_at: '2026-05-12T14:20:00Z' },
  { id: 'qc-005', playbook_id: 'pb-001', check_number: 5, check_name: 'Competitive landscape identifies actual incumbents, not generic competitors', category: 'Accuracy', status: 'pass', details: 'Identified actual Belfius vendors: Wolters Kluwer FRR (confirmed by LinkedIn job postings), potential Temenos exposure, and FNZ for wealth management. No generic competitors listed.', created_at: '2026-05-12T14:20:00Z' },
  ...
  { id: 'qc-009', playbook_id: 'pb-001', check_number: 9, check_name: 'No fabricated data — all claims are sourced or marked [UNVERIFIED]', category: 'Integrity', status: 'pass', details: '47 sources cited. 2 data points marked [UNVERIFIED]: exact Wolters Kluwer contract value and specific NBB audit findings. All other claims sourced.', created_at: '2026-05-12T14:20:00Z' },
...
export const MOCK_SECTIONS: PlaybookSection[] = [
  {
    ...
    content: `# Executive Summary — Belfius Bank × TracEI Compliance Suite

## Why Belfius, Why Now, Why TracEI

**The Opportunity:** Belfius faces a convergent compliance challenge in 2026: simultaneous enforcement of DORA (Digital Operational Resilience Act), updated NBB expectations on AI governance, and an internal transformation towards a "Belfius Digital" model that requires compliance infrastructure to keep pace with technology.
...
**The Entry Point:** The appointment of a new CTO (Thomas Verheyden, March 2026) represents a rare window — a technology leader open to new vendors, evaluating the compliance infrastructure he inherited, and accountable for delivering the "Belfius Digital" transformation.

**TracEI's Fit:**
- **DORA compliance automation** — Belfius must prove digital operational resilience to NBB by Q2 2026
...
**Deal Value:** €220K-€380K ARR (Tier 1 Belgian bank profile, based on comparable ING Belgium + KBC deal sizes).`,
    status: 'reviewed',
...
## Company Overview
**Belfius Bank & Insurance NV** is a Belgian financial institution wholly owned by the Belgian Federal State. Headquartered in Brussels, it operates across retail banking, insurance, public & social banking, and corporate banking.

**Key Stats (2025 Annual Report):**
- Total assets: €157.2 billion
- Net profit 2025: €842 million (+7% YoY)
- Employees: ~7,800 FTE
- Market position: #3 Belgian bank (behind BNP Paribas Fortis and KBC)
- Rating: Moody's A2, S&P A

## Strategic Initiatives (2026)
1. **"Belfius Digital" Transformation** — €400M+ multi-year investment in digital infrastructure. New CTO Thomas Verheyden (appointed March 2026) is accountable for delivery.
...
3. **DORA Compliance Roadmap** — NBB-mandated readiness assessment by Q2 2026. Current infrastructure is partially compliant.
4. **AI Governance Framework** — Responding to NBB circular on AI use in financial services (Feb 2026). Compliance team building new oversight processes.
...
- **Supervisor:** National Bank of Belgium (NBB) + ECB (SSM — Belfius is a significant institution)
...
**Goal:** Demonstrate NBB readiness for DORA by Q2 2026. Reduce compliance team's operational burden.
...
**Message:** Lead with ROI: "TracEI customers reduce compliance reporting time by 70% — at Belfius scale, that's approximately €2.8M in operational savings annually."

### Thomas Verheyden — CTO (TECHNICAL BUYER)
**Pain:** Inherited a fragmented compliance infrastructure. Needs to rationalize vendor stack as part of "Belfius Digital."
...
### Signal 1: DORA Enforcement + Belfius Gap
**Date:** January 17, 2025 (DORA enforcement date) — ongoing NBB remediation through 2026
**Source:** NBB supervisory circular + ECB SSM Q1 2026 assessment notes
**Detail:** Belfius received a supervisory observation on digital operational resilience in Q1 2026. The observation specifically notes "inadequate automated incident reporting and detection capabilities." NBB expects a remediation plan with a working system by Q3 2026.
...
**Date:** March 14, 2026
**Source:** Belfius press release + LinkedIn announcement (2,847 likes — high visibility)
**Detail:** Thomas Verheyden appointed as Chief Technology Officer. Previously VP Digital at ING Belgium where he led the migration off Wolters Kluwer FRR to a modern compliance stack. He has public statements on "vendor rationalization" in enterprise banking.
...
**Source:** Belfius 2025 Full Year Results (public)
...
### Signal 4: NBB AI Governance Circular
**Date:** February 3, 2026
**Source:** NBB Circular 2026-02 on AI in financial services
**Detail:** NBB requires Belgian banks to have documented AI governance frameworks in place by December 2026. Belfius has significant AI usage in credit scoring and fraud detection — all requires new compliance oversight.
**TracEI relevance:** TracEI's AI compliance module directly addresses NBB circular requirements.`,
    status: 'complete',
  ...
  },
  {
    ...
    content: `# Competitive Landscape at Belfius
...
**Contract value estimate:** €800K-€1.2M/year (based on Belfius size and typical WK FRR licensing)
**Weakness at Belfius:**
...
- New CTO Thomas Verheyden replaced WK FRR at ING Belgium — has first-hand experience of its limitations

**TracEI displacement strategy:** Don't attack WK FRR head-on. Instead, position as "the DORA gap filler" — WK FRR doesn't cover DORA's new requirements adequately, and Belfius needs to either buy an add-on or switch. Our module is a clean DORA solution that can eventually consolidate.
...
| Belgian regulatory rules | ✅ NBB-specific | ✅ Yes | ❌ Generic |
| AI compliance (NBB circular) | ✅ Yes | ❌ No | ❌ No |
| Implementation time | 8-12 weeks | 6-9 months | 12-18 months |`,
  ...
  },
  {
    ...
    content: `# Cultural & Regulatory Context — Belgian Banking

## Communication Rules (Belgium — Financial Services)
...
- **Response expectations:** Belgian bankers respond within 3-5 business days to relevant outreach. Don't follow up in under 72 hours.
- **Meeting format:** Virtual acceptable for initial intro; in-person strongly preferred for substantive discussions. Brussels office meetings, not video calls, close deals.
- **Language:** Dutch for Flemish contacts (Belfius HQ is Brussels — bilingual). Default to English for written follow-up; it's the working language of Belgian banking compliance teams.
...
- **Always lead with regulatory context:** Belgian banking buyers respond to "your regulator requires X" before they respond to "our product does Y."
- **NBB references:** The National Bank of Belgium is more trusted than vendor claims. Use "NBB circular 2026-02 requires..." framing.
- **GDPR sensitivity:** Never mention collecting personal data in outreach emails. Belgian banking compliance teams are GDPR-trained and will immediately flag any data privacy concerns.
- **Avoid:** "AI-powered" as a lead — Belgian banking has complex AI governance requirements and the term triggers caution. Use "automated" or "rules-based with AI assistance" instead.

## Cultural Don'ts (Belgian Banking)
...
- ❌ American informality — "Hey Inge!" in an email to a C-suite Belgian banker is an immediate disqualifier`,
    status: 'complete',
...
5. **Email — CCO** (Day 35) — Follow up InMail with formal email. Include 1-page DORA gap assessment for Belgian banks.
...
- NBB inspection announcement → Immediate "DORA support" message to CCO
- Belfius press release or earnings → Relevant content response within 24 hours
...
**Subject:** DORA Article 17 — What Belfius needs by Q3

Geachte mevrouw Ampe,

Uw team staat voor een specifieke uitdaging in 2026: de NBB verwacht vóór Q3 een aantoonbare automatisering van DORA-incidentmelding (Artikel 17). Volgens onze analyse van de supervisory observations die Belgische significante instellingen hebben ontvangen, is geautomatiseerde detectie het meest voorkomende aandachtspunt.

Bij TracEI hebben we dit specifieke DORA-probleem opgelost voor twee Europese banken van vergelijkbare omvang. De implementatie duurde 10 weken en de NBB-review verliep zonder aandachtspunten.

Zou u 20 minuten beschikbaar hebben voor een technische briefing? Geen verkooppitch — gewoon een concrete bespreking van hoe Belfius aan Artikel 17 kan voldoen vóór uw volgende supervisory review.
...
Ik had u eerder een bericht gestuurd over DORA Artikel 17-vereisten. Bijgevoegd vindt u ons assessment van de vijf meest voorkomende compliance-gaps bij Belgische banken van uw omvang — specifiek gericht op de NBB supervisory observations uit Q1 2026.
...
**Subject:** Vendor rationalization in Belgian banking compliance

Dear Thomas,

Congratulations on the CTO appointment — following your work at ING Belgium has been insightful.

You're likely doing exactly what you did at ING: assessing the compliance infrastructure you inherited and evaluating whether it serves where Belfius Digital is heading.

The specific challenge at a bank of Belfius's profile: DORA's new incident reporting requirements aren't well-served by legacy compliance platforms that were designed for Basel III, not for digital operational resilience.
...
One data point that may be relevant: the 70% reduction in compliance reporting time our clients achieve translates to approximately €2.4M-€3.1M in annual operational savings at a bank of Belfius's scale (based on your disclosed compliance headcount and the NBB-mandated reporting workload).

I'm not in a position to promise those exact numbers — every institution is different. But I'd be glad to walk your team through the methodology behind that estimate, and let you assess whether it applies to Belfius's situation.
...
**Response:**
"Wolters Kluwer FRR is an excellent platform for Basel-era compliance reporting — and we know it well. The challenge is that FRR was designed before DORA, the AI Act, and the NBB's new operational resilience requirements. Belgian banks are discovering they need to either buy WK's DORA add-on (which adds cost and complexity) or find a purpose-built solution.

We're not here to replace FRR on day one. Many of our clients run TracEI alongside FRR for the new regulatory requirements, and eventually consolidate. The starting point for Belfius would be DORA Article 17 automation — which FRR doesn't currently cover."
...
**Frequency:** High (Belgian banking IT teams are stretched)
**Response:**
"That's the right concern. Implementation complexity is the #1 reason compliance tech projects get killed internally. TracEI is designed for exactly this constraint: API-first, connects to your existing data sources without replacing them, and our Belgian banking implementation team handles all NBB configuration.
...
**Frequency:** Medium
**Response:**
"We understand Belgian banking procurement cycles. For DORA compliance specifically, there's a regulatory urgency argument that can accelerate procurement — the NBB observation letter creates a compliance risk that procurement committees treat differently from discretionary purchases.

We've helped two Belgian financial institutions use a 'regulatory urgency' pathway through their procurement process. Happy to share how that was structured."

---

## Objection 4: "Can you guarantee data stays in Belgium/EU?"
**Frequency:** High (GDPR + regulatory data sensitivity)
**Response:**
"All data processed by TracEI is hosted in AWS eu-central-1 (Frankfurt) — EU residency guaranteed. We're happy to provide our Data Processing Agreement, which includes specific clauses on sub-processor locations and the prohibition on any data transfer outside the EU. Our DPA has been reviewed and approved by the legal teams of 4 Belgian financial institutions."`,
    status: 'complete',
...
### Asset 1: "Belfius-Specific DORA Gap Assessment" (1-pager)
**Purpose:** Door opener for CCO outreach
**Format:** PDF, 2 pages maximum
**Content:** Specific Article 17 (incident reporting) and Article 23 (ICT risk management) gap analysis relevant to a Belgian significant institution with Belfius's IT profile
**Production:** 3 hours with TracEI DORA knowledge base
**Gating:** Ungated — attached directly to outreach email

### Asset 2: "ROI Calculator — Compliance Automation for Belgian Banks"
...
**Key:** Pre-populate with Belgian banking industry benchmarks so CFO can see relevant estimates immediately
**Production:** 8 hours

### Asset 3: "DORA Article 17 Implementation Guide for Belgian Banks" (5-page white paper)
**Purpose:** Nurture CCO and regulatory team
**Topic (specific):** "DORA Article 17 Incident Reporting: The 5 gaps most Belgian banks are missing — and how to close them before your NBB supervisory review"
**Differentiation from generic DORA guides:** Belgian-specific — references NBB supervisory observations, Belfius-relevant technology profile
**Production:** 12 hours

### Asset 4: "Flemish Bank Case Study" (with metrics)
**Purpose:** Late-stage proof for C-suite
**Content:** 10-week implementation, DORA Article 17 compliance achieved, NBB review outcome, cost savings
...
| Content asset downloads (1-pager) | 3+ from Belfius domain | Gating + UTM tracking |
...
| ROI calculator usage | 1+ from Belfius domain | Analytics |
...
- ❌ Meeting declined with "not a priority" → Investigate timing; consider waiting for NBB announcement
...
|--------|------|------|------------|
| Belfius 2025 Annual Report | Official | March 2026 | High |
| Belfius Q4 2025 Earnings Transcript | Official | Feb 2026 | High |
| NBB Circular 2026-02 (AI Governance) | Regulatory | Feb 2026 | High |
...
| Belfius CTO announcement (press release) | Official | March 14, 2026 | High |
| DORA Official Journal (EU) | Regulatory | Jan 2025 | High |

### Medium Confidence Sources (12)
| Source | Type | Notes |
|--------|------|-------|
| The Org — Belfius org chart | Third-party | May be 3-6 months outdated |
...
| Belgian banking compliance forum posts | Community | Anecdotal but directionally useful |
...
| NBB DORA observation details | [UNVERIFIED] | Inferred from supervisory pattern, not confirmed |
